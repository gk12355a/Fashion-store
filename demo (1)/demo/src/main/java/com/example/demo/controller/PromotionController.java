...
public class PromotionController {
    ...
    // Tìm kiếm khuyến mãi theo keyword và loại - TẠM COMMENT
    /*
    @GetMapping("/search")
    public ResponseEntity<Map<String, Object>> searchPromotions(
        ...
        try {
            ...
            Page<PromotionResponseDTO> promotionsPage = promotionService.searchPromotions(keyword, type, pageable);
    ...
    */
    ...
    // Lấy khuyến mãi theo loại - TẠM COMMENT
    /*
    @GetMapping("/type/{type}")
    public ResponseEntity<Map<String, Object>> getPromotionsByType(@PathVariable String type) {
        try {
            List<PromotionResponseDTO> promotions = promotionService.getPromotionsByType(type);
    ...
    */
    ...
    // Lấy khuyến mãi còn hiệu lực - TẠM COMMENT
    /*
    @GetMapping("/active")
    ...
    */
    ...
    // Lấy khuyến mãi sắp hết hạn - TẠM COMMENT
    /*
    @GetMapping("/expiring-soon")
    public ResponseEntity<Map<String, Object>> getExpiringSoonPromotions() {
        try {
            List<PromotionResponseDTO> promotions = promotionService.getExpiringSoonPromotions();
    ...
    */
    ...
    // Kiểm tra tên khuyến mãi - TẠM COMMENT
    /*
