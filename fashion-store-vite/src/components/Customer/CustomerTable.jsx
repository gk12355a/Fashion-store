        ...
        {customers.length > 0 ? (
          customers.map((c) => (
            <tr key={c.id} className={trClass}>
              ...
              <td className={`${tdClass} text-left pl-3`}>
                {c.name}
              </td>
              ...
              <td className={tdClass}>
                <button className={editButtonClass} onClick={() => handleEdit(c)}>
                  ✏️
                </button>
                <button
          ...
          <tr>
            <td colSpan="7" className="py-4 px-3 text-center text-gray-500">Không tìm thấy khách hàng</td>
          </tr>
        )}
      </tbody>
    </table>
