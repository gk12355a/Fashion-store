        ...
        {products.length > 0 ? (
          products.map((p) => (
            <tr key={p.id} className={trClass}>
              ...
              <td className={`${tdClass} whitespace-nowrap`}>{p.price.toLocaleString()} đ</td>
          ...
          <tr><td colSpan="9" className="py-4 px-3 text-center text-gray-500">Không tìm thấy sản phẩm</td></tr>
        )}
      </tbody>
    </table>
  );
